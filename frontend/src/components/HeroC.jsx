...
const HeroC = () => {
  ...
  return (
    <div>
       <h1 className="text-9xl font-semibold text-center mx-auto pt-25 pb-5">Best of the week</h1>
            ...
            <div className="flex justify-center items-center gap-6 h-125 max-w-full mx-auto p-12.5">
                {data.map((item,index) => (
                    ...
                    <img className={`h-full w-full object-cover ${item.position}`}
                        ...
                        alt="" />
                    <div
                        className="absolute inset-0 flex flex-col justify-end p-7.5 text-white bg-black/30 opacity-0 group-hover:opacity-100 transition-all duration-300">
