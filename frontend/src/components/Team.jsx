        ...
        <div className='w-full h-[80vh] flex justify-center items-center '>
            ...
            <div className='w-[55%] h-full flex justify-center items-center'>
                <div className='w-[80%]'>
                    ...
                    <NavLink to='/contact' className='m-7.5 mt-0 bg-black text-white px-5.5 py-2.5 rounded-[10px] hover:cursor-pointer hover:scale-102 hover:opacity-80'>Join Our Community</NavLink>
